...
export const START_LOADING_MENU_TAB = 'step-analysis/start-loading-menu-tab';
export const FINISH_LOADING_MENU_TAB = 'step-analysis/end-loading-menu-tab';
...
export const HANDLE_CLIENT_PLUGIN_ACTION = 'step-analysis/handle-client-plugin-action';